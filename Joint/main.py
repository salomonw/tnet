...
def solve_od_fcoffs(G_data, g_data, g_k, fcoeff, tNet, opt_method):
	...
	for i in range(100):
		...
		#dxdb = tnet.get_dxdb(tNet, delta=0.01, divide=1, log_time=logtime_data)
		dxdb = False
		#print(dxdb)
		#s
		#print(dxdb)
		...
		# solve joint bilevel
			g_k, fcoeff = tNet.solve_jointBilevel(G_data, dxdb, dxdg, g_tr = g_tr, beta_tr = beta_tr, scaling=1, c=30, lambda_1=0)
